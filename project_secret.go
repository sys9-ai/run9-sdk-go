...
func (c *Client) ListProjectSecrets(ctx context.Context) ([]ProjectSecretView, error) {
	return projectGeneratedResult[[]ProjectSecretView](c, func(projectCID string) (any, error) {
		return c.portal.Projects.ListProjectSecretsContext(ctx, &projects.ListProjectSecretsParams{
...
func (c *Client) CreateProjectSecret(ctx context.Context, req CreateProjectSecretRequest) (ProjectSecretView, error) {
	...
	return projectGeneratedResult[ProjectSecretView](c, func(projectCID string) (any, error) {
		return c.portal.Projects.CreateProjectSecretContext(ctx, &projects.CreateProjectSecretParams{
			ProjectCid: projectCID,
			Request:    payload,
		}, c.auth)
	})
...
func (c *Client) UpdateProjectSecret(ctx context.Context, secretID string, req UpdateProjectSecretRequest) (ProjectSecretView, error) {
	...
	return projectGeneratedResult[ProjectSecretView](c, func(projectCID string) (any, error) {
		return c.portal.Projects.UpdateProjectSecretContext(ctx, &projects.UpdateProjectSecretParams{
			ProjectCid: projectCID,
...
func (c *Client) DeleteProjectSecret(ctx context.Context, secretID string) error {
	return projectGeneratedAction(c, func(projectCID string) (any, error) {
		return c.portal.Projects.DeleteProjectSecretContext(ctx, &projects.DeleteProjectSecretParams{
			ProjectCid: projectCID,
			SecretID:   strings.TrimSpace(secretID),
		}, c.auth)
	})
...
func (c *Client) ListBoxSecrets(ctx context.Context, boxID string) ([]ProjectSecretView, error) {
	return projectGeneratedResult[[]ProjectSecretView](c, func(projectCID string) (any, error) {
		return c.portal.Boxes.ListBoxSecretsContext(ctx, &boxes.ListBoxSecretsParams{
			ProjectCid: projectCID,
...
func (c *Client) CreateBoxSecret(ctx context.Context, boxID string, req CreateProjectSecretRequest) (ProjectSecretView, error) {
	...
	return projectGeneratedResult[ProjectSecretView](c, func(projectCID string) (any, error) {
		return c.portal.Boxes.CreateBoxSecretContext(ctx, &boxes.CreateBoxSecretParams{
			ProjectCid: projectCID,
			ID:         strings.TrimSpace(boxID),
			Request:    payload,
		}, c.auth)
...
func (c *Client) UpdateBoxSecret(ctx context.Context, boxID string, secretID string, req UpdateProjectSecretRequest) (ProjectSecretView, error) {
	...
	return projectGeneratedResult[ProjectSecretView](c, func(projectCID string) (any, error) {
		return c.portal.Boxes.UpdateBoxSecretContext(ctx, &boxes.UpdateBoxSecretParams{
			ProjectCid: projectCID,
			ID:         strings.TrimSpace(boxID),
			SecretID:   strings.TrimSpace(secretID),
			Request:    payload,
...
func (c *Client) DeleteBoxSecret(ctx context.Context, boxID string, secretID string) error {
	return projectGeneratedAction(c, func(projectCID string) (any, error) {
		return c.portal.Boxes.DeleteBoxSecretContext(ctx, &boxes.DeleteBoxSecretParams{
			ProjectCid: projectCID,
			ID:         strings.TrimSpace(boxID),
			SecretID:   strings.TrimSpace(secretID),
		}, c.auth)
